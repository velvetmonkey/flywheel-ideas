...
Pass 1 also asserted several specific technical failure modes (HTML shifts, rate limits, mapping layers) without evidence about the actual implementation or constraints. Those are plausible, but I treated them as likely outcomes rather than contingent risks.
