...
Comp store sales may be referred to as "same store" sales by other retail companies. The method for calculating comp store sales varies across the retail [[industrials|industry]], therefore our measure of comp store sales may not be comparable to that of other retail companies.
