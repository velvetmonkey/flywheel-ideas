...
Companies that offer products that replicate the full range of capabilities we provide. For example, [[googl|Google]] has integrated social functionality into a number of its products, including search and Android, as well as other, largely regional, social networks that have strong positions in particular countries.
