...
In our Data Center platform, we announced more than 50 NVIDIA A100-powered systems; powered eight of the 10, and two-thirds of the total systems, on the latest TOP500 list of the world's fastest supercomputers; set 16 AI performance records on the latest MLPerf benchmarks; made the NVIDIA A100 Tensor Core GPU available on [[googl|Google]] Cloud; provided CUDA GPU-acceleration for Apache Spark; and unveiled the NVIDIA Mellanox UFM Cyber-AI Platform.
