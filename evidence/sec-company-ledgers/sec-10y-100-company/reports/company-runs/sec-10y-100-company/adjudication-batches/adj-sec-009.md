...
### 1. DIS / Regulation and legal

- Candidate count: 1
- Candidate IDs: cout-r8Gq1Yqt
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-r8Gq1Yqt"], confirm: true })`
...
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-1RjGvEZj"], confirm: true })`
...
### 3. DIS / Regulation and legal

- Candidate count: 1
- Candidate IDs: cout-dR9Wd8qh
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-dR9Wd8qh"], confirm: true })`
...
### 4. DIS / Geopolitics and tariffs

- Candidate count: 1
- Candidate IDs: cout-sb6nTUak
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-sb6nTUak"], confirm: true })`
...
### 5. DIS / Geopolitics and tariffs

- Candidate count: 1
- Candidate IDs: cout-W6pLYKH8
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-W6pLYKH8"], confirm: true })`
...
### 6. DIS / Geopolitics and tariffs

- Candidate count: 1
- Candidate IDs: cout-XQujDkei
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-XQujDkei"], confirm: true })`
...
### 9. DIS / Geopolitics and tariffs

- Candidate count: 1
- Candidate IDs: cout-cvNPXuCE
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-cvNPXuCE"], confirm: true })`
...
### 10. DIS / Regulation and legal

- Candidate count: 1
- Candidate IDs: cout-nDNuHLAq
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-nDNuHLAq"], confirm: true })`
...
### 11. DIS / Geopolitics and tariffs

- Candidate count: 1
- Candidate IDs: cout-me3CrjR6
- Max confidence: 0.92
- Apply command: `company.apply_outcomes({ run_id: "sec-10y-100-company", outcome_candidate_ids: ["cout-me3CrjR6"], confirm: true })`
