---
id: company-run-sec-10y-100-company-thesis-deltas
type: report
report_kind: company_thesis_deltas
...
date: '2026-05-08'
created: '2026-05-08T16:38:07.650Z'
---
# Thesis Deltas sec-10y-100-company

- **MCD**: new_watchpoint (0.62)
  - The liquidity/financial-results narrative in 2016–2017 filings shows meaningful influence from non-recurring items (strategic charges, impairments, and large gains on asset/restaurant business sales), suggesting a watchpoint around earnings/cash-flow interpretability and the role of refranchising/asset transactions in reported performance.
- **WMT**: thesis_unchanged (0.72)
  - Across the referenced filings, Walmart’s “Inventory and channel” risk factor language on physical asset/inventory loss and business interruption from natural disasters and related events remains substantively consistent, indicating no clear thesis-relevant shift in this specific risk framing over 2017–2020.
- **TMUS**: insufficient_evidence (0.63)
  - The provided SEC-filing evidence highlights (1) an accounting change affecting recognized credit losses on credit-risk exposures (including EIP receivables) and (2) episodic handset OEM recall impacts requiring revenue deferral and inventory impairment with expected reimbursement. These are identifiable watchpoints, but the dataset slice does not establish what specifically changed in the overarching thesis over time.
- **KO**: thesis_unchanged (0.62)
...
- **SBUX**: insufficient_evidence (0.72)
...
- **AVGO**: new_watchpoint (0.63)
  - Across successive filings, Broadcom’s macro/FX risk disclosure expands from primarily recession/inflation/credit-tightening and trade tensions to explicitly include (i) financial-market volatility, (ii) geopolitical conflicts, and (iii) government policy objectives (e.g., onshoring), while also framing potential impacts more directly in terms of cash flows and liquidity. This supports adding a new watchpoint rather than concluding the underlying macro/FX thesis clearly strengthened or weakened.
- **PM**: new_watchpoint (0.63)
...
- **AMD**: new_watchpoint (0.72)
  - Across AMD’s recurring risk-factor language on cyclicality, demand/supply imbalance, and channel inventory adjustment, the notable thesis-relevant delta is a more concrete, event-driven inventory risk tied to U.S. export restrictions affecting specific data center GPU products (MI308), including a large recorded inventory-related charge and reliance on export licenses for certain China shipments.
- **CSCO**: thesis_unchanged (0.62)
  - Across the referenced Cisco filings (2023-09-07 through 2026-02-17), the supply-chain thesis signal appears stable: Cisco continues to emphasize dependency on timely supplier/contract manufacturer deliveries and the possibility of shortages/lead-time disruptions. No clear filing-to-filing directional shift (improving vs worsening) is evidenced from the provided excerpts alone.
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-thesis-deltas",
  "entity_type": "company_thesis_deltas",
  "path": "reports/company-runs/sec-10y-100-company/thesis-deltas.md"
}
```
