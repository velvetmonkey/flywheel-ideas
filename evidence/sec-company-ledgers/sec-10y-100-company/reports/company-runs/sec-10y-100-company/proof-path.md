---
id: company-run-sec-10y-100-company-proof-path
type: report
report_kind: company_proof_path
...
- **HD / Cybersecurity and privacy**
  ...
  - Later evidence: Home Depot disclosed a data breach involving stolen payment-card information and customer email addresses, $161M of pretax expenses net of expected insurance recoveries, and related class-action/shareholder litigation.
...
- **MU / AI, R&D, and technology**
  - Prior assumption: the company could manage this risk without material disruption.
  - Later evidence: Micron disclosed $171M of restructuring charges in 2023, primarily related to employee severance, while pursuing a plan expected to generate cost savings.
  - Human verdict: 1 accepted failure verdict(s).
...
- **TJX / Liquidity**
  - Prior assumption: the company could manage this risk without material disruption.
  - Later evidence: TJX completed make-whole calls for $2B of debt and recorded a $242M pre-tax loss on early extinguishment, reducing fiscal 2022 pre-tax margin by 2.0 points and EPS by $0.15.
  - Human verdict: 1 accepted failure verdict(s).
...
- **MO / Liquidity**
  - Prior assumption: the company could manage this risk without material disruption.
  - Later evidence: Altria disclosed a $2.5B non-cash pre-tax impairment charge on its ABI equity investment after concluding the fair-value decline was other-than-temporary.
  - Human verdict: 1 accepted failure verdict(s).
...
- **LOW / Liquidity**
  - Prior assumption: the company could manage this risk without material disruption.
  - Later evidence: Lowe's disclosed a $530M non-cash impairment charge associated with exiting the Australian home improvement market.
  - Human verdict: 1 accepted failure verdict(s).
...
- **PM / Liquidity**
  - Prior assumption: the company could manage this risk without material disruption.
  - Later evidence: PM recorded a $204M non-cash pre-tax charge after concluding an adverse outcome was probable, with a stated $0.11 diluted EPS impact.
  - Human verdict: 1 accepted failure verdict(s).
...
## Live Bets Under Review Pressure

- **NFLX / Demand**
  - Assumption: asm-bmBJ3gyo
  - Observations: 84; latest 2026-04-17; pressure 5
...
- **PM / Geopolitics and tariffs**
  ...
  - Observations: 54; latest 2026-04-24; pressure 4
  - Why it matters: Staged evidence exists; review before treating this assumption as intact.
- **MSFT / Demand**
  - Assumption: asm-GpdfFh1C
  - Observations: 84; latest 2026-04-29; pressure 2
  - Why it matters: Staged evidence exists; review before treating this assumption as intact.
- **VZ / Demand**
  - Assumption: asm-ktbpwdZ5
  - Observations: 84; latest 2026-05-01; pressure 1
  - Why it matters: Staged evidence exists; review before treating this assumption as intact.
- **KO / Demand**
  - Assumption: asm-5B3UtjSr
  - Observations: 84; latest 2026-04-30; pressure 1
  - Why it matters: Staged evidence exists; review before treating this assumption as intact.
- **MSFT / Liquidity**
  - Assumption: asm-pvTxdvNS
  - Observations: 64; latest 2026-04-29; pressure 1
  - Why it matters: Staged evidence exists; review before treating this assumption as intact.
...
- The ledger preserves old assumptions instead of replacing them with disconnected summaries.
- Accepted outcomes change assumption state only after human judgment.
- Lessons become reusable review rules rather than one-off filing snippets.
- Pending candidates remain visible as review work, not automated verdicts.

## What This Does Not Prove

- It does not prove a buy/sell recommendation.
- It does not prove SEC filings are independent truth.
- It does not prove the lessons improve returns without further field evidence.
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-proof-path",
  "entity_type": "company_proof_path",
  "path": "reports/company-runs/sec-10y-100-company/proof-path.md"
}
```
