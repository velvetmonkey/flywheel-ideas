---
id: >-
  company-run-sec-10y-100-company-pattern-supply-chain-single-supplier-manufacturing
type: report
...
date: '2026-05-08'
created: '2026-05-08T16:38:08.019Z'
---
# Supply chain / Single supplier or manufacturing concentration sec-10y-100-company
...
Supply chain is now connected to accepted lesson evidence through the single supplier or manufacturing concentration mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
- **NVDA / Information Technology** (2016-03-17)
...
```flywheel-audit-json
{
  "schema": "sec-company-ledger-markdown-v1",
  "run_id": "sec-10y-100-company",
  "entity_id": "company-run-sec-10y-100-company-pattern-supply-chain-single-supplier-manufacturing",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/supply-chain-single-supplier-manufacturing.md"
}
```
