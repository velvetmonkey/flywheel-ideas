...
Customer and platform dependency is now connected to accepted lesson evidence through the geographic concentration or local disruption mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
- **MAR / Consumer Discretionary** (2016-04-28)
  - Each of our hotel brands competes with major hotel chains, as well as home and apartment sharing services, in national and international venues and with independent companies in regional markets. Our ability to remain competitive and to attract and retain business and leisure travelers depends on our success in distinguishing the quality, value, an
- **MAR / Consumer Discretionary** (2016-07-28)
  - Each of our hotel brands competes with major hotel chains, as well as home and apartment sharing services, in national and international venues and with independent companies in regional markets. Our ability to remain competitive and to attract and retain business and leisure travelers depends on our success in distinguishing the quality, value, an
...
```flywheel-audit-json
{
  "schema": "sec-company-ledger-markdown-v1",
  "run_id": "sec-10y-100-company",
  "entity_id": "company-run-sec-10y-100-company-pattern-customer-platform-dependency-geographic-concentration",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/customer-platform-dependency-geographic-concentration.md"
}
```
