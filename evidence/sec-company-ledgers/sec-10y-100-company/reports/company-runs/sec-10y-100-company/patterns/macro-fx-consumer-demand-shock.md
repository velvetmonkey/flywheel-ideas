---
id: company-run-sec-10y-100-company-pattern-macro-fx-consumer-demand-shock
type: report
report_kind: company_cross_sector_pattern_page
schema: sec-company-ledger-markdown-v1
run_id: sec-10y-100-company
entity_id: company-run-sec-10y-100-company-pattern-macro-fx-consumer-demand-shock
entity_type: company_cross_sector_pattern_page
source: flywheel-ideas
date: '2026-05-08'
created: '2026-05-08T16:38:08.047Z'
---
# Macro and foreign exchange / Consumer or end-market demand shock sec-10y-100-company
...
Macro and foreign exchange is now connected to accepted lesson evidence through the consumer or end-market demand shock mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
- **WMT / Consumer Staples** (2017-03-31)
...
- **WMT / Consumer Staples** (2017-06-02)
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-pattern-macro-fx-consumer-demand-shock",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/macro-fx-consumer-demand-shock.md"
}
```
