...
- Observations: 896
- Realized candidates: 18
- Signal: shared mechanism with realized-risk evidence

## What We Can Learn

Geopolitics and tariffs is not just recurring boilerplate: the geographic concentration or local disruption mechanism has already produced realized-risk candidates in this run, so related open bets in other sectors deserve review.
