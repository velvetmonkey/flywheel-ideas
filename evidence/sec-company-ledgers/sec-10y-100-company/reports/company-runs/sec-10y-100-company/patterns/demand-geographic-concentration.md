---
id: company-run-sec-10y-100-company-pattern-demand-geographic-concentration
type: report
...
Demand is now connected to accepted lesson evidence through the geographic concentration or local disruption mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-pattern-demand-geographic-concentration",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/demand-geographic-concentration.md"
}
```
