---
id: >-
  company-run-sec-10y-100-company-pattern-cloud-data-center-capacity-capacity-investment-opex
type: report
...
date: '2026-05-08'
created: '2026-05-08T16:38:08.119Z'
---
# Cloud and data center capacity / Capacity investment and operating expense drag sec-10y-100-company
...
- **AMD / Information Technology** (2016-02-18)
  - Pursuant to the WSA, we are required to purchase all of our microprocessor and APU product requirements, and a certain portion of our GPU product requirements, from GF with limited exceptions. If GF is unable to achieve anticipated manufacturing yields, remain competitive using or implementing advanced leading-edge process technologies needed to ma
- **AMD / Information Technology** (2016-02-18)
...
- **VZ / Communication Services** (2016-02-23)
...
```flywheel-audit-json
{
  "schema": "sec-company-ledger-markdown-v1",
  "run_id": "sec-10y-100-company",
  "entity_id": "company-run-sec-10y-100-company-pattern-cloud-data-center-capacity-capacity-investment-opex",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/cloud-data-center-capacity-capacity-investment-opex.md"
}
```
