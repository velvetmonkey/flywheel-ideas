---
id: company-run-sec-10y-100-company-pattern-macro-fx-interest-credit-liquidity
type: report
...
Macro and foreign exchange is now connected to accepted lesson evidence through the interest, credit, or liquidity stress mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
- **COST / Consumer Staples** (2016-03-09)
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-pattern-macro-fx-interest-credit-liquidity",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/macro-fx-interest-credit-liquidity.md"
}
```
