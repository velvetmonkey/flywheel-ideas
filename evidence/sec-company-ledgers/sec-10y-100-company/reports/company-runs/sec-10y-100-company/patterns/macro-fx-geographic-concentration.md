---
id: company-run-sec-10y-100-company-pattern-macro-fx-geographic-concentration
type: report
...
date: '2026-05-08'
created: '2026-05-08T16:38:08.025Z'
---
...
Macro and foreign exchange is now connected to accepted lesson evidence through the geographic concentration or local disruption mechanism, so similar open bets across sectors should be reviewed before treating the disclosure as harmless boilerplate.
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-pattern-macro-fx-geographic-concentration",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/macro-fx-geographic-concentration.md"
}
```
