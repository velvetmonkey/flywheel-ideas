---
id: company-run-sec-10y-100-company-pattern-macro-fx-capacity-investment-opex
type: report
report_kind: company_cross_sector_pattern_page
schema: sec-company-ledger-markdown-v1
run_id: sec-10y-100-company
entity_id: company-run-sec-10y-100-company-pattern-macro-fx-capacity-investment-opex
entity_type: company_cross_sector_pattern_page
source: flywheel-ideas
date: '2026-05-08'
created: '2026-05-08T16:38:08.060Z'
---
# Macro and foreign exchange / Capacity investment and operating expense drag sec-10y-100-company
...
- **MU / Information Technology** (2016-01-08)
  - In the past we have utilized external sources of financing when needed. As a result of our debt levels, expected debt amortization and general economic conditions, it may be difficult for us to obtain financing on terms acceptable to us. There can be no assurance that we will be able to generate sufficient cash flows, use cash held by MMJ to fund i
...
- **MU / Information Technology** (2016-04-08)
  - In the past we have utilized external sources of financing when needed. As a result of our debt levels, expected debt amortization and general economic conditions, it may be difficult for us to obtain financing on terms acceptable to us. There can be no assurance that we will be able to generate sufficient cash flows, use cash held by MMJ to fund i
...
- **MU / Information Technology** (2016-07-06)
  - In the past we have utilized external sources of financing when needed. As a result of our debt levels, expected debt amortization, and general economic conditions, it may be difficult for us to obtain financing on terms acceptable to us. There can be no assurance that we will be able to generate sufficient cash flows, use cash held by MMJ to fund 
- **SBUX / Consumer Discretionary** (2016-07-27)
  - Certain statements herein, including statements regarding trends in or expectations relating to the expected effects of our initiatives and plans, as well as trends in or expectations regarding revenues, operating margins, comparable store sales, anticipated net new stores, the effects of foreign currency translation, earnings per share, tax rates,
...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-pattern-macro-fx-capacity-investment-opex",
  "entity_type": "company_cross_sector_pattern_page",
  "path": "reports/company-runs/sec-10y-100-company/patterns/macro-fx-capacity-investment-opex.md"
}
```
