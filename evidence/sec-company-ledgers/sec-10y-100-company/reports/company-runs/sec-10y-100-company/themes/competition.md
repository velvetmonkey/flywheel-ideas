...
```flywheel-audit-json
{
  ...
  "entity_id": "company-run-sec-10y-100-company-theme-competition",
  "entity_type": "company_theme_page",
  "path": "reports/company-runs/sec-10y-100-company/themes/competition.md"
}
```
